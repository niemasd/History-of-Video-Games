...
REGIONS_THE = {'Czech Republic', 'Eurozone', 'Middle East', 'Philippines', 'UAE', 'UK', 'USA'}
        ...
        for company_data in companies_sorted:
            ...
            for console_data in consoles_sorted[company_data['name_safe']]:
                ...
                if 'photo' in console_data:
                    ...
                    if company_data['name'] not in console_data['name']: # avoid e.g. "Nintendo Nintendo Entertainment System"
                        md_f.write('[%s](#%s) ' % (company_data['name'], company_data['name_safe']))
